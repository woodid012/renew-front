...
export default function AdministratorPage() {
  ...
  const handleDeletePortfolio = async (portfolioName) => {
    ...
    try {
      ...
      const updatedPortfolios = storedPortfolios.filter(p => p !== portfolioName);
      ...
      alert(`Portfolio "${portfolioName}" has been deleted successfully.`);
    } catch (error) {
                ...
                <div className="divide-y divide-gray-200">
                  {portfolios.length === 0 ? (
                    ...
                    portfolios.map((portfolio) => {
                      const isDefault = portfolio === 'ZEBRE' || portfolio === 'xxx';
                      return (
                        <div
                          key={portfolio}
