...
// Glassbox Time Array Demo
// Main page component using the data-driven P&L framework
...
import * as helpers from './lib/timeArrayHelpers.js'
import { calculateAll, buildHierarchy, calculateMetrics } from './lib/calculationEngine.js'
import { defaultInputs, initializeInputs } from './lib/defaultInputs.js'
import { defaultLineItems } from './lib/defaultLineItems.js'
import { generateExcelData, downloadCSV } from './lib/excelExport.js'
...
export default function GlassboxPage() {
    ...
    const handleExportCSV = useCallback(() => {
        ...
        downloadCSV(excelData, 'glassbox_output.csv')
    }, [timeline, results])
    ...
    const renderLineItem = (item, depth = 0) => {
        ...
        return (
            <div key={item.id}>
                <div
                    className={`flex items-center justify-between py-2 px-3 hover:bg-gray-100 cursor-pointer ${depth === 0 ? 'font-semibold bg-gray-100' : ''
                ...
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-xl font-bold text-gray-900">Glassbox Financial Model</h1>
                                <p className="text-sm text-gray-500">Time Array P&L Framework</p>
                            </div>
                        </div>
                            ...
                            <div className="p-4 space-y-4">
                                ...
                                {selectedItem.calcParams?.formula && (
                                    <div className="bg-gray-100 rounded-lg p-3 border border-gray-300">
                                        ...
                                        <code className="text-gray-900 text-sm font-mono">{selectedItem.calcParams.formula}</code>
                                    </div>
                                )}
