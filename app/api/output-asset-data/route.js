...
export async function GET(request) {
  try {
    ...
    const numericalFields = [
      ...
      'solarRevenue',
      'solarContractedGreenRevenue',
      'solarContractedEnergyRevenue',
      'solarMerchantGreenRevenue',
      'solarMerchantEnergyRevenue',
      'bessRevenue',
      'bessContractedEnergyRevenue',
      'bessMerchantEnergyRevenue',
      'monthlyGeneration',
      'avgGreenPrice',
      'avgEnergyPrice',
      'opex',
